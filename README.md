...
## Precomputed Results
We provide the computational results used in our evaluation under 'results/' in the subfolders `im_results`, `indulpet_results`, and `rand_results`. They are equivalent to the files obtained by running the three notebooks again.
